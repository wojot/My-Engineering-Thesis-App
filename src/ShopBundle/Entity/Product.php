...
class Product
{
     ...
     * @var string
     *
     * @ORM\Column(name="depth", type="decimal", precision=10, scale=2)
     */
    private $depth;
     ...
     * Add image
     *
     * @param \ShopBundle\Entity\Image $image
     *
     * @return Product
     */
    public function addImage(\ShopBundle\Entity\Image $image)
    {
        $this->images[] = $image;
     ...
     * @param \ShopBundle\Entity\Image $image
     */
    public function removeImage(\ShopBundle\Entity\Image $image)
    {
